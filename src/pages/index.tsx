  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Car Sharing Application, your ultimate platform for hassle-free, reliable and efficient car sharing services. Join us, drive more, worry less."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1594291465146-1cf039f0ddc2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYXIlMkJzaGFyaW5nfGVufDB8fHx8MTY5ODQxMjI3NXww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Car Sharing Application, your ultimate platform for hassle-free, reliable and efficient car sharing services. Join us, drive more, worry less.`}
            </Text>
            <Box
